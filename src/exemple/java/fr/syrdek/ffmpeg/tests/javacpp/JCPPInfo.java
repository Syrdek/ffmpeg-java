    ...
    for (int i = 0; i < formatCtx.nb_streams(); i++) {
      ...
      if (LOG.isDebugEnabled()) {
        ...
        case avutil.AVMEDIA_TYPE_AUDIO:
          LOG.debug("Stream {} : type=Audio, codec={}, id={}, channels={}, sample rate={}", i,
              codec.long_name().getString(), codec.id(), codecParams.channels(), codecParams.sample_rate());
          break;
        case avutil.AVMEDIA_TYPE_VIDEO:
          LOG.debug("Stream {} : type=Video, codec={}, id={}, resolution {}x{}", i, codec.long_name().getString(),
              codec.id(), codecParams.width(), codecParams.height());
          break;
        default:
          LOG.debug("Stream {} : type={}, codec={}, id={}", i, codecParams.codec_type(), codec.long_name().getString(),
              codec.id());
          break;
        }
      }
